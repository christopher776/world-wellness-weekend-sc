...
import { fetchMarketplaceItems, marketplaceAvailability, type MarketplaceAvailability, type MarketplaceItem } from "@/lib/marketplace";
...
export default async function MarketplacePage() {
  ...
  try { items = await fetchMarketplaceItems({ publishedOnly: true }); availability = await marketplaceAvailability(items); }
  catch { items = []; availability = []; }
